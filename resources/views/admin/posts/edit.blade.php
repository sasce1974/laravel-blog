    ...
    <div class="row">
        <div class="col-lg-9 col-md-12">
            ...
            <div class="card card-small mb-3">
                <div class="card-body">
                    <form method="post" action="/admin/posts/{{$post->id}}" enctype="multipart/form-data" class="add-new-post">
                        {{csrf_field()}}
                        ...
                        <div class="input-group">
                            ...
                            <input name="title" class="form-control form-control-lg mb-3 col-lg-8" type="text" value="{{$post->title}}">
