        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
                ...
                <nav class="navbar align-items-stretch navbar-light bg-white flex-md-nowrap border-bottom p-0">
                    <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                        <div class="d-table m-auto">
                            <img id="main-logo" class="d-inline-block align-top mr-1 align-middle" style="max-width: 50px;" src="/images/logo.png" alt="3Delacto logo">
                            <span class="d-none d-md-inline ml-1 align-middle">3Delacto</span>
                        </div>
                    </a>
            ...
            {{--<form action="#" class="main-sidebar__search w-100 border-right d-sm-flex d-md-none d-lg-none">--}}
                {{--<div class="input-group input-group-seamless ml-3">--}}
                    {{--<div class="input-group-prepend">--}}
                        ...
                        {{--</div>--}}
                    {{--</div>--}}
                    {{--<input id="search" class="navbar-search form-control" type="text" placeholder="Search for post..." aria-label="Search"> </div>--}}
            {{--</form>--}}
            @if(Auth::check())
            <div class="nav-wrapper">
                <ul class="nav flex-column">
                    ...
                    @endif
                    <li class="nav-item">
                        {{--<span class="float-right d-inline-block"><a href="/sent_messages">Sent</a></span>--}}
                    ...
                    {{--<li class="nav-item">--}}
                        {{--<a class="nav-link " href="{{route('new_message')}}">--}}
                    ...
                    @if(Auth::check())
                    <li class="nav-item">
                        <a class="nav-link " href="{{route('show_user', Auth::id())}}">
                ...
                <nav class="navbar align-items-stretch navbar-light flex-md-nowrap p-0">
                    <form action="#" class="main-navbar__search w-100 d-none d-md-flex d-lg-flex">
                        <div class="input-group input-group-seamless ml-3">
                            ...
                            <input id="search" name="search" class="navbar-search form-control" type="text" placeholder="Search for something..." aria-label="Search"> </div>
                    </form>
                    <ul class="navbar-nav border-left flex-row ">
                        <li class="nav-item border-right dropdown notifications">
                            <a class="nav-link nav-link-icon text-center" href="#" role="button" id="messagesLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="nav-link-icon__wrapper">
                                    <i class="material-icons">email</i>
                                    {{--Show not read emails... --}}
                                    @if($count_msgs = count(\App\Message::where(['sent_to'=> Auth::id(), 'viewed'=>0])->get())>0)
                                    <span class="badge badge-pill badge-danger">
{{--                                        {{count(\App\Message::where(['sent_to'=> Auth::id(), 'viewed'=>0])->get())}}--}}
                                        {{$count_msgs}}
                                    </span>
                                    @endif
                                </div>
                            </a>
                            <div class="dropdown-menu dropdown-menu-small" aria-labelledby="messageLink">
                                <a class="dropdown-item" href="{{route('inbox')}}">
                                    ...
                                    <div class="notification__content">
                                        <span class="notification__category">Messages</span>
                                        <p>You have {{$count_msgs > 0 ? $count_msgs : "no"}} new messages. Click here to read them all!</p>
                                    </div>
                                </a>
                                {{--<a class="dropdown-item" href="#">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="notification__content">--}}
                                        {{--<span class="notification__category">Feedback</span>--}}
                                        {{--<p>You have--}}
                                            {{--<span class="text-danger text-semibold">2</span> new feedback's by other users!</p>--}}
                                    {{--</div>--}}
                                {{--</a>--}}
                    ...
                    {{--<ul class="navbar-nav border-left flex-row ">--}}
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                <img class="user-avatar rounded-circle mr-2" src="{{Auth::user()->medias ? '/storage/' . Auth::user()->medias['file'] : 'http://placehold.it/100x100'}}" alt="User Avatar">
                                <span class="d-none d-md-inline-block">{{Auth::user()->name}}</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-small">
                                <a class="dropdown-item" href="{{route('show_user', Auth::id())}}">
            ...
            {{--Table for searched TODO: table to be absolute centered shown if data--}}
            {{--<table class="table table-bordered table-hover">--}}
                ...
                {{--</tbody>--}}
            {{--</table>--}}
            <div class="position-absolute col-lg-8 float-right m-5" style="z-index: 999">
                <div class="bg-dark text-light rounded pl-4 hover" id="search-container"></div>
            </div>
            ...
            <div class="main-content-container container-fluid px-4">
                ...
                <div class="page-header row no-gutters py-4">
                    <span class="text-uppercase page-subtitle">@yield('small-title')</span>
                    <div class="col-12 col-sm-4 text-center text-sm-left mb-0">

                        <h4 class="page-title">@yield('big-title')</h4>
                    </div>
                </div>
                <!-- End Page Header -->
            ...
            <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
              ...
              <a href="http://3delacto.com" rel="nofollow">3Delacto</a>
            </span>
            </footer>
        </main>
    </div>
...
<!-- Javascript to make current links (<a href...>) with 'active' class -->
<script>
    $(document).ready(function() {
        $('.nav-item a[href="' + 'http://posting.test' + this.location.pathname + '"]').addClass('active');
    });
</script>
